...
'Key of Light (Key Trilogy (Paperback))', 'Killjoy',
'Kiss the Girls',
'L Is for Lawless',
'Ladder of Years',
'Lake Wobegon Days',
...
function rateBook(rating) {
  ...
  // You can add your logic here to save the rating or perform other actions.
}
...
function display(result){
  ...
  for (let i = 0; i < listItems.length; i++) {
    listItems[i].addEventListener("click", function() {
      const clickedItem = listItems[i].innerText;
      inputBox.value = clickedItem; // set the value of the input box to the clicked item
      resultsBox.innerHTML = ""; // clear the result box
      document.querySelector('input[type="submit"]').click(); // click the submit button
